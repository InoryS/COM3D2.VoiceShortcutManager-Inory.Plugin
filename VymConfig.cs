...
namespace COM3D2.VoiceShortcutManager.Plugin
{
	...
	public class VymConfig
	{
		...
		public VymFaceMotionInfo[] vymFaceMotion = {
			...
			new VymFaceMotionInfo(new string[]{"普通の目", "目戻して"}).addFaceTag(new string[]{"eyeclose:0", "eyeclose2:0", "eyeclose3:0", "eyeclose6:0", "eyebig:0", "hitomis:0", "hitomih:0"}),
			new VymFaceMotionInfo(new string[]{"目を開けて"}).addFaceTag(new string[]{"eyeclose:0", "eyeclose2:0", "eyeclose3:0", "eyeclose6:0", "eyebig:0"}),
			new VymFaceMotionInfo(new string[]{"見開いて"}).addFaceTag(new string[]{"eyeclose:0", "eyeclose2:0", "eyebig:100"}),
			new VymFaceMotionInfo(new string[]{"目を閉じて", "目をつぶって"}).addFaceTag(new string[]{"eyeclose:100", "eyeclose2:0", "eyeclose3:0", "eyeclose6:0", "eyebig:0"}),
			new VymFaceMotionInfo(new string[]{"目をにっこり"}).addFaceTag(new string[]{"eyeclose:0", "eyeclose2:100", "eyebig:0"}),
			new VymFaceMotionInfo(new string[]{"少し目を開けて"}).addFaceTag(new string[]{"eyeclose:-10", "eyeclose2:-10"}),
			...
			new VymFaceMotionInfo(new string[]{"普通の眉", "眉戻して"}).addFaceTag(new string[]{"mayuup:0", "mayuha:0", "mayuv:0", "mayuw:0", "mayuvhalf:0"}),
			...
			new VymFaceMotionInfo(new string[]{"舌出して"}).addFaceTag(new string[]{"tangopen:+25", "tangout:100", "tangup:0"}),
			new VymFaceMotionInfo(new string[]{"舌戻して"}).addFaceTag(new string[]{"tangopen:0", "tangout:0", "tangup:0"}),

			//モーション変更 (.anmは不要)
			new VymFaceMotionInfo(new string[]{"基本立ち"}).addMotion(new string[]{"maid_stand01"}, true),
			new VymFaceMotionInfo(new string[]{"ぽよんぽよん"}).addMotion(new string[]{"edit_pose21_mune_tate_f_once_"}, true),
			new VymFaceMotionInfo(new string[]{"ぷるんぷるん"}).addMotion(new string[]{"edit_pose21_mune_yoko_f_once_"}, true),
			...
			new VymFaceMotionInfo(new string[]{"ピロートークキス"}).addMotion(new string[]{"pillow_talk_dakituki_kiss_f"}, true),
			...
			new VymFaceMotionInfo(new string[]{"体を隠す"}).addMotion(new string[]{"sys_munehide"}, true).addFace("恥ずかしい", "頬０涙０"),
			new VymFaceMotionInfo(new string[]{"お辞儀する"}).addMotion(new string[]{"kaiwa_tati_ozigi_n_f_once_"}, true),
			new VymFaceMotionInfo(new string[]{"バイバイ"}).addMotion(new string[]{"kaiwa_tati_teofuru_taiki_f"}, true),
			//連続再生 待機モーションループ
			new VymFaceMotionInfo(new string[]{"お辞儀"}).addMotion(new string[]{"kaiwa_tati_ozigi_n_f_ONCE_","kaiwa_tati_taiki_f"}, true),
			new VymFaceMotionInfo(new string[]{"敬礼"}).addMotion(new string[]{"kaiwa_tati_keirei_f_ONCE_","kaiwa_tati_keirei_taiki_f"}, true),
			new VymFaceMotionInfo(new string[]{"ごめんね"}).addMotion(new string[]{"kaiwa_tati_ayamaru_f_ONCE_","kaiwa_tati_ayamaru_taiki_f"}, true),
			new VymFaceMotionInfo(new string[]{"がっくり"}).addMotion(new string[]{"kaiwa_tati_orz_f_once_","kaiwa_tati_orz_taiki_f","kaiwa_tati_orz_tatiagaru_f_ONCE_","maid_stand01"}, true),
			new VymFaceMotionInfo(new string[]{"ソファ手合わせ"}).addMotion(new string[]{"kaiwa_sofa_teawase_f_ONCE_","kaiwa_sofa_teawase_taiki_f","kaiwa_sofa_teawase_end_f_ONCE_", "kaiwa_sofa_1_f"}, true),

			//放尿ポーズ 待機モーションループ
			new VymFaceMotionInfo(new string[]{"露出放尿", "おしっこポーズ"}).addMotion(new string[]{"rosyutu_hounyou_f_once_","rosyutu_hounyou_taiki_f"}, true).addFace("恥ずかしい", "頬０涙０"),
			new VymFaceMotionInfo(new string[]{"犬放尿"}).addMotion(new string[]{"inu_hounyou_f_once_","inu_taiki_f"}, true).addFace("恥ずかしい", "頬０涙０"),
			new VymFaceMotionInfo(new string[]{"変態放尿"}).addMotion(new string[]{"hentai_pose_hounyou_f_once_","hentai_pose_03_f"}, true).addFace("恥ずかしい", "頬０涙０"),
